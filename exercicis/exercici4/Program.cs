...
class Program
{
    static void Main(string[] args)
    {
        ...
        Console.WriteLine("Aixo en pesetes és " + euro * 166.386); //Aixó escriu a la terminal lo estipulat a les cometes + la variable euros convertides a nombre enter * 166.386 per que et doni els euros en pesetes
